 ...
 */
@RestController public class AttendanceCoreController{private final AttendanceCoreService service;/**
                                                                                                   * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                                                                                                   */
public AttendanceCoreController(AttendanceCoreService service){this.service=service;}
 /**
  * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
  */
  ...
  * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
  */
 @PostMapping("/api/core/attendance/periods/{id}/requests")ApiResponse<AttendanceCoreService.AttendanceRequest>request(@PathVariable Long id,@Valid@RequestBody AttendanceCoreService.CreateAttendanceRequest r){return ApiResponse.ok(service.createRequest(id,r));}
 /**
  * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
  */
 @GetMapping("/api/core/attendance/periods/{id}/requests")ApiResponse<List<AttendanceCoreService.AttendanceRequest>>requests(@PathVariable Long id){return ApiResponse.ok(service.requests(id));}
 /**
  * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
  */
 @PostMapping("/api/admin/core/attendance/requests/{id}/review")ApiResponse<AttendanceCoreService.AttendanceRequest>review(@PathVariable Long id,@Valid@RequestBody AttendanceCoreService.ReviewRequest r){return ApiResponse.ok(service.reviewRequest(id,r));}
 /**
  * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
  */
